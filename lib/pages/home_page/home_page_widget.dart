import 'package:e_m_r_s_m_b/NFCbatchdemerit.dart';
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: Color(0xFF392393),
          automaticallyImplyLeading: false,
          leading: ClipRRect(
            borderRadius: BorderRadius.circular(8.0),
            child: Image.asset(
              'assets/images/eMRSMB.png',
              width: 180.0,
              height: 206.63,
              fit: BoxFit.cover,
            ),
                  ...
                  child: Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () {
                        ...
                        Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context)=>SecondScreen()) //the folder is meritdata.dart
                        );
                      },
                      text: 'MERIT DATA',
                ...
                Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () {
                      ...
                      Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context)=>NFCDemeritPage())
                      );
                    },
                    text: 'ASSIGN DEMERIT',
                    options: FFButtonOptions(
                ...
                Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () {
                      ...
                      Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context)=>NfcOutingScreen())
                      );
                    },
                    text: 'OUTING',
                    options: FFButtonOptions(
